    ...
    renderIcons(data: any) {
        return (
            <>
                ...
                <img style={{cursor: 'pointer', marginLeft:"30px"}}  alt={"edit"} src={require('../../Assets/editIcon.svg')}  onClick={() => { this.props.history.push({ pathname: "/manage-loans/loan-products/edit-loan-product", state: { id: data.id } }) }}></img>
            </>
        );
    }
    async getProducts() {
