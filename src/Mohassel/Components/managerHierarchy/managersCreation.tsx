            ...
            <div>
                ...
                <Form className="managers-form">
                    <Form.Group className={'managers-form-group'} as={Col} id="operationsManager">
                        ...
                        <Row><UsersSearch isManager usersInitial={this.state.users}  objectKey={'operationsManager'} item={this.state.values}  disabled = {this.state.disabled}/> </Row>
                    </Form.Group>
                    <Form.Group className={'managers-form-group'} as={Col} id="districtManager">
                        ...
                        <Row><UsersSearch isManager usersInitial={this.state.users}  objectKey={'areaManager'} item={this.state.values}  disabled = {this.state.disabled}/> </Row>
                    </Form.Group>
                    <Form.Group className={'managers-form-group'} as={Col} id="districtSupervisor">
                        ...
                        <Row><UsersSearch isManager usersInitial={this.state.users}  objectKey={'areaSupervisor'} item={this.state.values}  disabled = {this.state.disabled}/> </Row>
                    </Form.Group>
                    <Form.Group className={'managers-form-group'} as={Col} id="centerManager">
                        ...
                        <Row><UsersSearch isManager usersInitial={this.state.users}  objectKey={'centerManager'} item={this.state.values}  disabled = {this.state.disabled}/> </Row>
                    </Form.Group>
                    <Form.Group className={'managers-form-group'} as={Col} id="branchManager">
                        ...
                        <Row><UsersSearch isManager usersInitial={this.state.users}  objectKey={'branchManager'} item={this.state.values}  disabled = {this.state.disabled}/> </Row>
                    </Form.Group>
                </Form>
