...
const StepOneForm = (props: Props) => {
  ...
  return (
    <Form className={"branch-data-form"} onSubmit={props.handleSubmit}>
      ...
      <Row>
        <Col>
          <Form.Group className={"branch-data-group"} controlId={"name"}>
        ...
        <Col>
          <Form.Group className={"branch-data-group"} controlId={"governorate"}>
            <Form.Label className={"branch-data-label"}>
              {`${local.governorate}*`}
            </Form.Label>
      ...
      <Col className={"branch-data-group"}>
      ...
      <Row>
        <Col>
          <Form.Group className={"branch-data-group"} controlId={"address"}>
            <Form.Label className={"branch-data-label"}>
              {`${local.branchAddress}*`}
            </Form.Label>
            <Form.Control
        ...
        <Col>
          <Form.Group controlId={"postalCode"} className={"branch-data-group"}>
            <Form.Label className={"branch-data-label"}>
              {local.postalCode}
            </Form.Label>
            <Form.Control
