...
export const LoanProductValidation = Yup.object().shape({
    ...
    noOfInstallments: Yup.number().integer('Must be int').min(1, "Can't be less than 0").required('required!'),
    ...
    maxPrincipal: Yup.number().moreThan(Yup.ref('minPrincipal'),'Max should be greater than min').required('required!'),
    minInstallment: Yup.number().min(0, "Can't be less than 0").required('required!'),
    maxInstallment: Yup.number().moreThan(Yup.ref('minInstallment'),'Max should be greater than min').required('required!'),
