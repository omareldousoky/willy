  ...
  return (
    <Form onSubmit={handleSubmit} className="data-form">
      ...
      <Row>
        ...
        <Col>
          <Form.Group
            className="data-check-group row-nowrap"
      ...
      <Form.Group className="data-group" controlId="stamps">
        <Form.Label className="data-label" column sm={4}>
          {local.stamps}
        </Form.Label>
        <Row className="row-nowrap">
          <Col>
      ...
      <>
          ...
          {values.beneficiaryType === "group" && (
            <Col>
              <Form.Group
                ...
                controlId="individualApplicationFee"
              >
                <Form.Label className="data-label">
        ...
        {values.beneficiaryType === "group" && (
          <Form.Group
            className="data-group"
            controlId="applicationFeePercentPerPerson"
          >
            <Form.Label className="data-label">
      ...
      <Form.Group
        className="data-check-group row-nowrap"
        controlId="branchManagerAndDate"
      >
        <Form.Check
          type="checkbox"
