        ...
        return (
            <>
                ...
                <Container>
                    ...
                    {Object.keys(this.state.product).length > 0 && <div>
                        <Table striped bordered style={{ textAlign: 'right' }}>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{this.state.product.periodLength} {periodType(this.state.product.periodType)}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>{this.state.product.interest}% {interestPeriod(this.state.product.interestPeriod)}</td>
                                </tr>
                                <tr>
                                    <td>{local.allowInterestAdjustment}</td>
                                    <td>{(this.state.product.allowInterestAdjustment ? local.yes : local.no)}</td>
                                </tr>
                                <tr>
                                    <td>{local.inAdvanceFees}</td>
                                    <td>{this.state.product.inAdvanceFees} {inAdvanceFrom(this.state.product.inAdvanceFrom)}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>{(this.state.product.allowStampsAdjustment ? local.yes : local.no)}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>{(this.state.product.allowRepresentativeFeesAdjustment ? local.yes : local.no)}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>{(this.state.product.allowAdminFeesAdjustment ? local.yes : local.no)}</td>
                                </tr>
                                <tr>
                                ...
                                {this.state.product.beneficiaryType === 'individual' && <>
                                    ...
                                    <tr>
                                        ...
                                        <td>{this.state.product.applicationFeePercent}% {inAdvanceFrom(this.state.product.applicationFeeType)}</td>
                                    </tr>
                                </>
                                }
                                {this.state.product.beneficiaryType === 'group' && <>
                                    ...
                                    <tr>
                                        ...
                                        <td>{this.state.product.applicationFeePercentPerPerson}% {inAdvanceFrom(this.state.product.applicationFeePercentPerPersonType)}</td>
                                    </tr>
                                </>
                                }
                                <tr>
                                ...
                                {this.state.product.beneficiaryType !== 'group' && <>
                                    <tr>
                                        ...
                                        <td>{(this.state.product.mustEnterGuarantor ? local.yes : local.no)}</td>
                                    </tr>
