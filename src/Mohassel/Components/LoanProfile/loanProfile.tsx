                    ...
                    <div className="print-none">
                        <div className="d-flex justify-content-between">
                            ...
                            <div className="d-flex justify-content-end" style={{ width: '70%' }}>
                                ...
                                {this.state.application.status === 'issued' && !this.state.application.writeOff && <span style={{ cursor: 'pointer', borderRight: '1px solid #e5e5e5', padding: 10 }} onClick={() => this.writeOffApplication()}> <span className="fa fa-remove" style={{ margin: "0px 0px 0px 5px" }}></span>{local.writeOffLoan}</span>}
