    ...
    return (
        <div style={{ textAlign: 'right' }}>
            <div style={{ margin: '10px 0px' }}>
                ...
                <DynamicTable totalCount={0} pagination={false} data={members.installmentTable} mappers={mappers} />
            </div>
            {application.product.beneficiaryType !== "individual" && members.customerTable ?
                <DynamicTable totalCount={0} pagination={false} data={members.customerTable} mappers={membersMappers} />
                : null}
        </div>
    )
}