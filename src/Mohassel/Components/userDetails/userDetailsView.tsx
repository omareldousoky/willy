    ...
    return (
        <>
            ...
            <Table striped bordered hover >
                <tbody>
                    <tr><td style={header}>{local.creationDate}*</td><td style={cell}>{data.created.at}</td></tr>
                    <tr><td style={header}>{local.userRole}*</td><td style={cell}>{data.roles}</td></tr>
                    ...
                    <tr><td style={header}>{local.birthDate}*</td><td style={cell}>{data.birthDate}</td></tr>
                    ...
                    <tr><td style={header}>{local.dateOfHire}*</td><td style={cell}>{data.hiringDate}</td></tr>
                    ...
                    <tr><td style={header}>{local.branches}</td><td style={cell}>{data.branches}</td></tr>
                </tbody>
