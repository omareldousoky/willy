    ...
    return (
      <div className="clearance-paper-print" dir="rtl" lang="ar" key={index}>
        <table>
          ...
          <div className="rightText">
            وكذا انهاء كافه الضمانات الشخصيه السابق صدورها منه لصالح شركتنا
            لعملاء اخرين وذلك باجمالي مبلغ وقدره {clearance.principal} جنيه
          </div>
          <div className="rightText">
            {clearance.principal
          ...
          <div className="rightText">
            ولا يستحق لشركتنا قبل العميل / {clearance.customerName} ، ايه
            مديونيات او مستحقات حتي تاريخ هذا الخطاب .
          </div>
          <tr />
          <div className="rightText">
