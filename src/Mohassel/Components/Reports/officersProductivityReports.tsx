...
import { OfficersProductivityRequest } from '../../Models/OfficersProductivityReport';
    ...
    render() {
        return (
            <>
                ...
                <OfficersProductivity fromDate={"2021-03-11"} toDate={"2021-04-14"} data={this.state.dataToPrint} />
            </>
        )
    }
}
