...
export const UserDataForm = (props: Props) => {
  ...
  return (
    <Form onSubmit={handleSubmit} className=" user-data-form">
      <Form.Group className={"user-data-group"} controlId={"name"}>
      ...
      <Row>
        <Col sm={5}>
          <Form.Group controlId={"nationalId"} className={"user-data-group"}>
            <Form.Label className={"user-data-label"}>
              {`${local.nationalId}*`}
            </Form.Label>
      ...
      <Form.Group controlId="nationalIdIssueDate">
        <Form.Label
          className={"user-data-label"}
        >{`${local.nationalIdIssueDate}*`}</Form.Label>
        <Form.Control
          type="date"
      ...
      <Row>
        <Col>
          <Form.Group className={"user-data-group"} controlId={"hrCode"}>
            <Form.Label className={"user-data-label"}>
              {`${local.hrCode}*`}
            </Form.Label>
            <Form.Control
        ...
        <Col>
          <Form.Group controlId={"hiringDate"} className={"user-data-group"}>
            <Form.Label className={"user-data-label"}>
              {`${local.dateOfHire}*`}
            </Form.Label>
            <Form.Control
      ...
      <Form.Group controlId={"mobilePhoneNumber"} className={"user-data-group"}>
        <Form.Label className={"user-data-label"}>
      ...
      <Form.Group controlId={"username"} className={"user-data-group"}>
        <Form.Label className={"user-data-label"}>
          {`${local.username}*`}
        </Form.Label>
        <Can I="updateNationalIdAndUsername" a="user" passThrough>
      ...
      <Form.Group as={Row} className={"user-data-group"}>
        <Col>
          <Form.Label className={"user-data-label"}>
