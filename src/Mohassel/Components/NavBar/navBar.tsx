...
class NavBar extends Component<Props, State> {
  ...
  async goToBranch(branch: Branch, refresh: boolean) {
    ...
    if (res.status === "success") {
      document.cookie = 'ltsbranch=' + JSON.stringify(branch) + (process.env.REACT_APP_DOMAIN ? `;domain=${process.env.REACT_APP_LTS_SUBDOMAIN}${process.env.REACT_APP_DOMAIN}`: '' + ';path=/;');
