          ...
          return (
            <Form onSubmit={formikProps.handleSubmit}>
                ...
                <Col sm={4}>
                  <Form.Group controlId="customerName">
                    ...
                    <Form.Control
                      ...
                      isInvalid={Boolean(formikProps.errors.customerName && formikProps.touched.customerName)}
                    />
                ...
                <Col sm={4}>
                  <Form.Group controlId="nationalIdIssueDate">
                    ...
                    <Form.Control
                      ...
                      onChange={formikProps.handleChange}
                      onBlur={formikProps.handleBlur}
                      isInvalid={Boolean(formikProps.errors.nationalIdIssueDate && formikProps.touched.nationalIdIssueDate)}
                    />
                    <Form.Control.Feedback type="invalid">
              ...
              <Row>
                <Col sm={4}>
                  <Form.Group controlId="loanOwner">
                    <Form.Label className="customer-form-label" column>{`${local.loanOwner}*`}</Form.Label>
                    <div className="age-range-container">
                      <div onClick={() => {
                        formikProps.setFieldValue('loanOwner', true);
                      }}
                        className={`item ${formikProps.values.loanOwner ? 'active' : ''}`}> {local.personal}</div>
                      <div onClick={() => {
                        formikProps.setFieldValue('loanOwner', false);
                      }} className={`item ${formikProps.values.loanOwner ? '' : 'active'}`}>{local.notPersonal}</div>
                    </div>
                  </Form.Group>
                </Col>
              </Row>
              <Form.Group as={Row} className='branch-data-group'>
                ...
                <Col>
                  <Button className={'btn-submit-next'} style={{ float: 'left', width: '60%' }} type="submit" data-qc="submit">{local.next}</Button>
                </Col>
              </Form.Group>
            </Form>
          )
                  ...
                  <Form.Group controlId="businessAddressDescription">
                    ...
                    <InputGroup>
                      <Form.Control
                        ...
                        onChange={formikProps.handleChange}
                        onBlur={formikProps.handleBlur}
                        isInvalid={Boolean(formikProps.errors.businessAddressDescription && formikProps.touched.businessAddressDescription)}
                      />
                    </InputGroup>
                    <Form.Control.Feedback type="invalid">
