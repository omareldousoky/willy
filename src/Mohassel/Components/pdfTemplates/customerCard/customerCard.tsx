        ...
        {this.props.data.product.type === 'sme' ? (
          <ol>
            <li>
              ...
              شركة تساهيل للتمويل أو عبر أحد وسائل الدفع الالكتروني المعتمدة من
              هيئة الرقابة الماليه مع موافاة الفرع بصورة من المستند المؤيد لذلك
              .
            </li>
            ...
            <li>
              يحق لشركة تساهيل للتمويل المطالبة بقيمة القرض وكافة المصروفات
              تكاليف تمويله في حالة استخدام مبلغ القرض في غرض غير إستخدامه داخل
              النشاط أو إغلاق النشاط .
            </li>
          </ol>
        ) : (
          <ol>
            ...
            {this.props.data.product.beneficiaryType === 'individual' ? (
              <>
                ...
                <ul>
                  ويتم تحصيل ١٠ ج عن كل يوم تاخير اذا كان قيمه القسط اكبر من
                  ٣٠٠٠ ج .
                </ul>
              </>
            ) : (
              <>
                <li>
                  تلتزم الأعضاء بسداد غرامه تاخير قدرها ٥% من قيمه القسط في
                ...
                <ul>
                  يتم تحصيل ٣ ج عن كل يوم تأخير إذا كان قيمة القسط يتراوح من
                  ١٥٠٠ ج حتي٢٠٠٠ ج
                </ul>
                <ul>
