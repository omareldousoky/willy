    ...
    return (
        <div className="cash-receipt" lang="ar">
			...
			<span>{' ' + timeToArabicDate(0, false) + ' '}</span>
                        ...
                        <div>استلمت انا / {props.data.customer.customerName}، مبلغ {`${numbersToArabic(props.data.principal)} جنيها = (${new Tafgeet(props.data.principal, 'EGP').parse()})`} من شركة
                    ...
                    return (
                        <div key={index}>
                            <div className="bottomborder">
                                ...
                                <div>استلمت انا / {individualInGroup.customer.customerName}، مبلغ {`${numbersToArabic(individualInGroup.amount)} جنيها = (${new Tafgeet(individualInGroup.amount, 'EGP').parse()})`} من شركة
