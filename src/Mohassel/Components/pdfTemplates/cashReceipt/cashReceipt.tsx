    ...
    <div className="cash-receipt-pdf" lang="ar">
                  ...
                  <tr key={index}>
                    <td>
                      <div
                        ...
                        style={index === 4 ? { pageBreakAfter: 'always' } : {}}
                      >
                        <div className="headtitle textcenter">
                          ايصال استلام مبلغ نقدى
                        </div>
          ...
          <tr>
            <td>
              <div className="divFooter">
                ...
                <div>
                  تم توقيع العملاء امامنا وتم اخذ البصمه بمعرفتنا بعد التأكد من
                  شخصية العملاء والاطلاع علي اصل تحقيق الشخصيه وتسليم كل عميل
                  مبلغ التمويل الخاص به.
                </div>
      ...
      {props.remainingTotal > 0 && (
        <div className="check-balance-container">
          <h3 className="check-balance">{`توجد مديونية على العميل  يجب تحصيلها أولا بقيمة  ${props.remainingTotal}  جنيه`}</h3>
        </div>
      )}
    </div>
  )
