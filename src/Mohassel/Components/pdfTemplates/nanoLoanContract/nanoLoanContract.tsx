                ...
                <div className="main">
                  ...
                  <section>
                    ...
                    <div>
                      ...
                      المذكوره به وان هذه المبالغ تعد قيمه القرض وكافه مصروفانه
                      وتكاليف تمويله
                    </div>
                  </section>
                ...
                <div className="main">
                  <tbody>
                    ...
                    <div>
                      ...
                      مسئوليتي وانني قمت بمطابقة اصول{' '}
                      <span>{guarantors.length ? 'بطاقات' : 'بطاقة'}</span>{' '}
                      الرقم القومي{' '}
                      <span>
                        {guarantors.length ? 'لجميع اعضاء المجموعه' : 'العميل'}
                      </span>{' '}
