...
import  './LoanApplicationFeesTransaction.scss'
const LoanApplicationFeesTransaction = () => {
    return (
     <div className = "loan-application-fees" dir="rtl" lang="ar">
...
export default LoanApplicationFeesTransaction
