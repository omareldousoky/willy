					...
					<tbody>
						{response?.map((operationsManager, operationsManagerIndex) => (
							<Fragment key={operationsManagerIndex}>
								...
								{operationsManager.areaManagers?.map((areaManager, areaManagerIndex) => (
									<Fragment key={areaManagerIndex}>
										...
										{areaManager.areaSupervisors?.map((supervisor, supervisorIndex) => (
												...
												{supervisor.centerManagers?.map(
													(manager, managerIndex) => (
														<tr key={managerIndex}>
															...
															<td colSpan={2}>
																{manager.expectedPaymentsThisDuration || '0.00'}
															</td>
															<td colSpan={2}>
															...
															<td />
															<td colSpan={2}>{manager.reciepts || '0.00'}</td>
														</tr>
													)
												) || (
													<tr>
