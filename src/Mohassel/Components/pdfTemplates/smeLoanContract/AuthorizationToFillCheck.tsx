  ...
  <>
    <div className="contract-container" dir="rtl" lang="ar">
      ...
      <p>
        ...
        بالشيكات الموقعة منى لأمر شركة تساهيل والصادرة لصالح الشركة لوفاء أية
        التزامات مستحقة علينا ، ومن المتفق عليه ان الشركة سيقوم بملء البيانات
        وفقا لدفاتره التى نقبلها كدليل قاطع على التزاماتنا دون اى منازعة فى
        الحال والاستقبال.
      </p>
