    ...
    <>
      <div className="contract-container" dir="rtl" lang="ar">
        ...
        <p>
          ...
          سدادها بالكامل وأن يكون السداد عن طريق شركة تساهيل للتمويل أو من تنيبة
          الي حساب شركة تساهيل للتمويل بموجب إيداع نقدي أو تحويل بنكي أو عن طريق
          أي وسيلة دفع الكتروني معتمدة من هيئة الرقابة المالية مع موافاة فرع
          التعامل بصورة من مستند سداد القسط ولا يحق لنا بأي حال من الاحوال سداد
          قيمة أي قسط من الاقساط الي أي شخص بشركة تساهيل للتمويل وتكون
          مسئولياتنا كاملة ويعتبر السداد المخالف لذلك لم يتم ويحق لشركة تساهيل
          للتمويل الرجوع علي الشركة المدينة والضامنين في أي وقت من الاوقات بقيمة
          ما لم يتم سداده لحساب شركة تساهيل للتمويل ودون أدني إعتراض منا علي ذلك
