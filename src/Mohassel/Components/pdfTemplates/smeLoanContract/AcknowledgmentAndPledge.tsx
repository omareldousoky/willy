    ...
    <>
      <div className="contract-container" dir="rtl" lang="ar">
        ...
        <p>
          ...
          &emsp; &emsp; وحتي تمام سدادها بالكامل وأن يكون السداد عن طريق شركة تساهيل للتمويل
          ...
          الاحوال سداد قيمة أي قسط من الاقساط الي أي شخص بشركة تساهيل للتمويل وتكون
          مسئولياتنا كاملة ويعتبر السداد المخالف لذلك لم يتم ويحق لشركة تساهيل للتمويل الرجوع
          علي الشركة المدينة والضامنين في أي وقت من الاوقات بقيمة ما لم يتم
          سداده لحساب شركة تساهيل للتمويل ودون أدني إعتراض منا علي ذلك . وهذا إقرار منا بذلك
