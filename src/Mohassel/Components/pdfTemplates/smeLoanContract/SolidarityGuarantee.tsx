    ...
    <div className="contract-container mb-0 pb-0" dir="rtl" lang="ar">
      ...
      <ol>
        <li>
          ...
          تساهيل للتمويل متناهي الصغر لشركة اسم الشركة وأن توقيعي على الكفالة
          التضامنية بمثابة توقيعي على هذا العقد كطرف ثالث كفيل وضامن متضامن
          لسداد التمويل الممنوح من اسم الشركة من شركة تساهيل للتمويل متناهي
          الصغر لسادة شركة{' '}
        </li>
        <li>
