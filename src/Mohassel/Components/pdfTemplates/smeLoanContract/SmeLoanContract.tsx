                            ...
                            >
                              <thead>
                                ...
                                >
                                  ...
                                  <th colSpan={6}>
                                    ترخيص ممارسه نشاط تمويل المشروعات الصغيره
                                    والمتوسطة رقم ١ لسنه ٢٠٢١
                                  </th>
                                </tr>
                                <tr style={{ height: '10px' }} />
                              </thead>
                ...
                >
                  <div className="main">
                    ...
                    <section className="stakeholders">
                      <p>
                        <b>أولا:</b> شركة تساهيل للتمويل - شركه مساهمه مصريه -
                        مقيده بسجل تجاري استثمار القاهره تحت رقم
                    ...
                    <section>
                      ...
                      <div>
                        ...
                        لاحكام القانون رقم ١٤١ لسنه ٢٠١٤ وتعديلاته المشار اليه .
                      </div>
                      <div>
                    ...
                    <section>
                      ...
                      <div>
                        ...
                        {branchDetails.address} او بايداع بنكي وفي حاله رغبه
                        الطرف الثاني في جدوله او ترحيل القرض يقوم بتقديم طلب الي
                        الطرف الاول وعتد الموافقه عليه يتم فرض تكاليف خاصه بهذه
                        العمليه وفق نفس سعر العائد الممنوح به القرض وتكون
                        الجدوله بحد اقصي ضعف المده المتبقيه للعميل عند طلب
                        الجدول
                      </div>
                    </section>
                    ...
                    <section>
                      ...
                      <p>
                        يقر الطرفان الثانى والثالث بسداد كافه المبالغ الوارده
                        بالبند السابق وفقا للمواعيد المذكوره به وان هذه المبالغ
                        تعد قيمه القرض وكافه مصروفانه وتكاليف تمويله , ولا يحق
                        لأي منهما المنازعه فى ذلك اعمالا للماده ( 16 ) من
                        القانون رقم 141 لسنه 2014 الخاص بتمويل المشروعات
                    ...
                    <section>
                      ...
                      <div>
                        يلتزم الطرفان الثانى والثالث متضامنين فيما بينهما بسداد
                        اقساط القرض وفقا لما هو وارد بالبند الثالث من هذا العقد
                        وفى حاله تأخرهما فى سداد قيمه اى قسط فى تاريخ استحقاقه
                        يلتزما بسداد غرامه تأخير بواقع 5 جنيهات ( خمسة جنيهات
                        مصريا ) عن كل يوم تاخير تبدأ من اليوم التالى للاستحقاق
                        القسط وحتى تمام السداد ولا توجد فتره سماح عن تاريخ
                        الاستحقاق وذلك بحد اقصي 90 يوم من تاريخ الاستحقاق
                        المتاخر حتي اتخاذ الاجراءات القانونيه ضده مع ملاحظه انه
                        لابد من انذار الطرف الاول للطرف الثاني قبل اتخاذ اي
                        اجراء قانوني ضده
                      </div>
                    </section>
                          ...
                          <td>
                            <section>
                              ...
                              <div>
                                ...
                                العقد وتعتبر مكمله له وتختص المحاكم الاقتصاديه
                                بالفصل فى اى نزاع قد ينشأ بخصوص تفسير او تنفيذ
                                اى بند من بنود هذا العقد. كما تطبق احكام
                                القوانين الساريه بجمهوريه مصر العربيه فى حاله
                          ...
                          <td>
                            <section>
                              ...
                              <div>
                                ...
                                تحرر هذا العقد من عدد (________) نسخه تسلم لكل
                                طرف نسخه للعمل بمقتضاها عند اللزوم.
                              </div>
                            </section>
                          </td>
                        </tr>
                        <tr>
                          <td>
                            <section>
                              ...
                              <div>
                                يلتزم الطرف الاول بقبول طلب الطرف الثاني بالسداد
                                المعجل ويحق للطرف الاول خصم تكلفه التمويل الذي
                                تم فيه السداد ويجوز لها اضافه عموله سداد معجل
                                بما لا يزيد عن 5% من باقي المستحق ( اصل ) المراد
                                تعجيل الوفاء به
                              </div>
                            </section>
                          </td>
                        ...
                        <tr>
                          <td>
                            <section>
                              ...
                              <div>
                                يلتزم الطرف الاول بالحفاظ علي خصوصيه بيانات
                                ومعلومات الطرف الثاني والثالث وضمان عدم
                                استخدامها من قبل الطرف الاول او احد موظفيه او
                                وكلائه او مشاركتها مع اخرين دون الحصول علي
                                موافقه صريحه من الطرف الثاني والثالث وفي حدود
                                هذه الموافقه كما يلتزم الطرف الاول بالاحتفاظ
                                بالمستندات الخاصه بالعملاء لمده 5 سنوات من تاريخ
                                اخر معامله وفق متطلبات قانون غسل الاموال وتمويل
                                الارهاب
                              </div>
                              <div>
