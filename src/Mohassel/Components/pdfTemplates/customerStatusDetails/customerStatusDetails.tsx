...
const CustomerStatusDetails = (props) => {
    ...
    return (
            ...
            <table style={{ fontSize: "12px", margin: "10px 0px", textAlign: "center", width: '100%' }}>
                ...
                <tr style={{width:'100%',display:'flex',flexDirection:'row' , justifyContent:'space-between'}}><th colSpan={6} style={{backgroundColor: 'white'}}><img style={{ width: "70px", height: "35px" }} src={"https://i.ibb.co/WPmb0vp/logo.jpg"} /></th><th style={{backgroundColor:'white'}} colSpan={6}>ترخيص ممارسه نشاط التمويل متناهي الصغر رقم (2) لسنه 2015</th></tr>
                <tr style={{ height: "10px" }}></tr>
            </table>
                <table>
