            ...
            <tr>
              <td className="report-content-cell" style={{ textAlign: 'right' }}>
                <div className="main">
                      ...
                      {props.data.group.individualsInGroup.map((individualInGroup, index) => {
                        return (
                          <tr key={index}>
                            <td>
                              <div>
                                <span>السيدة {individualInGroup.customer.customerName} {individualInGroup.type === "leader" ? '(رئيس المجموعة)' : ''}</span>
                              </div>
                            </td>
                            <td>السن: {getAge(individualInGroup.customer.birthDate)}</td>
                            <td style={{ width: '30%' }}>
                              <div>
                                <b>عنوان المنزل:</b>
                                <span>
                        ...
                        {props.data.group.individualsInGroup.map((individualInGroup, index) => {
                          return (
                            <tr key={index}>
                              <td>
                                <div>
                                  <span>السيدة {individualInGroup.customer.customerName} </span>
                                </div>
                              </td>
                              <td style={{ width: '30%' }}>
                                <div>
                  ...
                  {timeToArabicDate(props.data.installmentsObject.installments[props.data.installmentsObject.installments.length - 1].dateOfPayment, false)} علي ان يتم السداد النقدي بمقر فرع الطرف الأول الكائن في {props.branchDetails.name}طرف الأول وذلك
                  ...
                  <section>
                    ...
                    غرامة
                    تأخير قدرها ٥% من قيمة
                    القسط في اليوم التالي لتاريخ الأستحقاق القسط وابتداء من اليوم الذي يليه كالتالي :-
							</div>
                  ...
                  <section>
                    ...
                    الوارده بهذا العقد
                    وملحقاته ومرفقاته الموقعه (ان وجدت) وبالقوانين الساريه في اي وقت من الأوقات يعد جميع افراد الطرف الثانى مخفقين
                    في الوفاء بالتزماتهم التعاقديه اوالقانونيه ويعتبر هذا العقد مفسوخا من
                    تلقاء نفسه دون حاجه الي اعذار او اتخاذ اجراءات قضائيه ويحق للطرف الاول فورا مطالبة افراد الطرف
                  الثاني ضامنين متضامنين فيما بينهم بباقي قيمة القرض وكافة مصروفاته و تكاليف تمويله</div>
                    ...
                    غير سليمه وذلك الي
								المقرض.</div>
                    <div>٧/٤ في حاله فقد ايا من افراد الطرف الثاني اهليته أو اشهار افلاسه او اعساره
                    او
                    وفاته او وضعه تحت
                    ...
                    <div>٧/٦ في حالة عدم قدرة ايا من افراد الطرف الثاني علي سداد الاقساط في مواعيدها
                    او
                    توقف اعمال المشروع
                  ...
                  <section>
                    ...
                    <div>اتخد كل طرف العنوان المبين قرين كل منهما بصدر هذا العقد محلاً مختار له وفي حالة تغيير أياً منهم لعنوانه يلتزم بأخطار الطرف الاخر بموجب خطاب مسجل بعلم الوصول وإلا اعتبر إعلانه على العنوان الاول صحيحاً ونافذاً ومنتجاً لكافة اثاره القانونية.</div>
                  </section>
