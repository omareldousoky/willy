              ...
              >
                <div className="main">
                  ...
                  <section>
                    ...
                    <div>
                      ...
                      الطرف الأول علي ذلك وفقا للشروط والضوابط الوارده بهذا
                      العقد وبعد ان اقر الطرفان بأهليتهم القانونيه للتصرف
                  ...
                  <section>
                    ...
                    <div>
                      ...
                      استحقاقه تلتزم الأعضاء بسداد غرامة تأخير قدرها ٥% من قيمة
                      القسط في اليوم التالي لتاريخ الأستحقاق القسط وابتداء من
                      اليوم الذي يليه كالتالي :-
                    </div>
                    <div>
                      يتم تحصيل ٢ ج لكل عضوة عن كل يوم تأخير اذا كان قيمة القسط
                      أقل من ١٥٠٠ ج
                    </div>
                    <div>
                      {' '}
                    ...
                    <div>
                      ...
                      التمويل للمجموعة يتراوح من ٢٠٠٠ ج حتي أقل من ٢٥٠٠ ج
                    </div>
                    <div>
                      يتم تحصيل ٥ ج لكل عضوة عن كل يوم تأخير اذا كان مبلغ
                      التمويل للمجموعة اكثر من او يساوى ٢٥٠٠ ج
                    </div>
                  </section>
                ...
                <div className="main">
                  ...
                  <div>
                    ...
                    في {timeToArabicDateNow(false)} وحتي تمام سدادها بالكامل،
                    وأن يكون السداد عن طريق احد الأعضاء او بواسطة من ينوب عن
                    المجموعة الي شركة تساهيل للتمويل متناهي الصغر ذاتها وبمقر
                    خزينة فرع الشركة المتعامل معه أو بأحدي وسائل الدفع
                    الالكتروني المعتمده من هيئة الرقابة المالية ولا يحق لنا بأى
                    حال من الاحوال سداد قيمة أي قسط من الاقساط الي شخص اخر غير
                    خزينة فرع الشركة طبقا لما سبق ذكره، وأيا كان هذا الصدد وتكون
                    مسئوليتنا كاملة ويعتبر السداد المخالف لذلك لم يتم ويحق
                    للشركة الرجوع علي الاعضاء بالمجموعة في أي وقت من الاوقات
                    بقيمة مالم يتم سداده لخزينة فرع الشركة ودون أدني اعتراض مننا
                    علي ذلك وهذا اقرار منا بذلك ولا يحق لنا الرجوع فيه حاليا او
                    مستقبلا.
                  </div>
                  <div>
