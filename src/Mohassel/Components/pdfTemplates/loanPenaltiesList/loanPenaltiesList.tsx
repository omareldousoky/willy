    ...
    return (
        <div className="loan-penalties-list" dir="rtl" lang="ar">
            <table className="report-container">
                ...
                <tbody>
                    <tr>
                        <th className="gray horizontal-line" colSpan={2}>تاريخ الحركه</th>
                        <th className="gray horizontal-line" colSpan={2}>2020/05/02</th>
                    </tr>
                </tbody>
                <tbody>
                    <tr>
                        <th className="gray horizontal-line" colSpan={2}>بنك / خرينه </th>
                        <th className="gray horizontal-line" colSpan={2}>بنك 1 - القاهره - شبرا مصر</th>
                    </tr>
                    <tr>
                        <td>1</td>
                        <td>001/00171760</td>
                    ...
                    <tr>
                        <td></td>
                        <td className="horizontal-line" colSpan={2}>إجمالي بنك / خزينه</td>
                        <td className="horizontal-line" colSpan={2}>بنك 1 - القاهره - شبرا مصر</td>
                        <td className="horizontal-line" colSpan={1}>2020/07/02</td>
                        <td className="horizontal-line">1</td>
                        <td></td>
                        <td className="horizontal-line">إجمالي المبلغ</td>
                        <td className="horizontal-line">1.00</td>
                    </tr>
                ...
                <tbody className="tbodyborder">
                    <tr>
                        <td></td>
                        <td className="gray horizontal-line" colSpan={2}>إجمالي تاريخ الحركه</td>
                        <td className="gray horizontal-line">2020/06/09</td>
                        <td></td>
                ...
                <tbody className="tbodyborder">
                    <tr>
                        <td></td>
                        <td className="gray horizontal-line" colSpan={2}>إجمالي بالعمله</td>
                        <td className="gray horizontal-line">جنيه مصري</td>
                        <td></td>
                        <td className="horizontal-line">إجمالي عدد الحركات</td>
                        <td className="horizontal-line">162</td>
                        <td></td>
                        <td className="horizontal-line">إجمالي المبلغ</td>
                        <td className="horizontal-line">1.00</td>
                    </tr>
