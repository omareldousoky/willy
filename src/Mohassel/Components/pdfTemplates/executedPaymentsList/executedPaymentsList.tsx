...
const ExecutedPaymentsList = (props) => {
    return (
        <div className="executed-payments-list" style={{ direction: "rtl" }} lang="ar">
            ...
            <table>
                <tbody>
                    <tr>
                        ...
                        <th className="frame">القيمة المسدده المصاريف</th>
                        <th className="frame">إجمالي</th>
                    </tr>
                    <tr>
                        <th className="frame" colSpan={2}>تاريخ الحركه</th>
                        <th className="frame" colSpan={2}>2020/6/14</th>
                    </tr>
                    <tr>
                        <th className="frame" colSpan={2}>بنك / خرينه </th>
                        <th className="frame" colSpan={2}>خرينه 5 فرع أبوتيج - اسيوط - أبوتيج</th>
                    </tr>
                    <tr>
                        <td>1</td>
                        <td>010/00125012</td>
                    ...
                    <tr>
                        <td className="frame" colSpan={2}>إجمالي بتك / خزينه</td>
                        <td className="frame" colSpan={2}>خرينه 5 فرع أبوتيج - اسيوط - أبوتيج</td>
                    ...
                    <tr>
                        <th className="frame" colSpan={2}>إجمالي تاريخ الحركه</th>
                        <th className="frame" colSpan={2}>2020/07/02</th>
                    ...
                    <tr>
                        <th className="frame" colSpan={2}>إجمالي بالعمله</th>
                        <th className="frame" colSpan={2}>جنيه مصري</th>
                        <td className="frame">إجمالي عدد الحركات</td>
                        <td className="frame">1</td>
                        <td colSpan={3}></td>
                        <td className="frame">2340.00</td>
