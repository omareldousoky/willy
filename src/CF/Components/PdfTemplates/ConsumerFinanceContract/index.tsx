      ...
      <div>
        ...
        <section className="term-container" title="fourth-term">
          <div className="head-title">
            ...
            <p>
              4/4 يلتزم العميل بسداد اقساط التمويل في المواعيد المتفق عليها
              للشركة من خلال بطاقات المدفوعات التجارية او احدي وسائل الدفع التي
              يقرها البنك المركزي.
            </p>
            <p>
              4/5 يلتزم الاطراف الثاني والثالث والرابع بصفتهم ضامنين متضامنين
              فيما بينهم بسداد إجمالي قيمة وأقساط التمويل وكافة المصروفات
              وتكاليف التمويل إلي الطرف الأول علي النحو السالف ذكره، او خصما من
              رصيده بأي محفظة ويعد التوقيع علي هذا العقد تفويض منه للشركة بذلك.
            </p>
          </div>
        </section>
        ...
        <section className="term-container" title="eleventh-term">
          ...
          <p>
            11/1 يلتزم الاطراف الثاني والثالث والرابع ضامنين متضامنين فيما بينهم
            بسداد أقساط التمويل وفقا لما هو وارد بالبند الثالث من هذا العقد وفي
            حالة تأخرهم في سداد قيمة أي قسط في تاريخ إستحقاقه يلتزموا بسداد
            غرامة تأخير كما يلي:
            <ul>
              <li>
          ...
          <p>
            11/2 يقر الاطراف الثاني والثالث والرابع ضامنين متضامنين فيما بينهم
            بسداد كافة المبالغ موضوع هذا العقد والموضحة ببنوده وفقا للمواعيد
            المذكورة به وأن هذه المبالغ تعد قيمة التمويل وكافة مصروفاته وتكاليف
            تمويله، ويضاف إليها اي مصاريف أو غرامات تأخير أخري ولا يحق لأي منهما
            المنازعة أو الاعتراض علي ذلك، وذلك إعمالا لنصوص القانون رقم 18 لسنة
            2020 الخاص بالتمويل الإستهلاكي.
          </p>
          <p>
            11/3 يقر الطرفان الثالث والرابع بصفتهم ضامنين متضامنين فيما بينهم
            بأنهم يكفلوا علي سبيل التضامن الطرف الثاني لقيمة هذا التمويل من أصل
            ومصاريف التمويل ويحق للممول (الطرف الأول) الرجوع عليهم بكامل قيمة
            وعوائد وعمولات وكافة المديونيات المستحقة علي هذا التمويل ولا يحق
            للاطراف الثالث او الرابع الدفع بالتجريد أو التقسيم أو أي دفوع أخري
            في مواجهة الممول (الطرف الأول) ويحق للطرف الأول الرجوع عليه وحده
            وعلي الضامنين المتضامنين (الثالث والرابع) منفردين او مجتمعين معا
            بكامل قيمة المديونيات المستحقة له.
          </p>
          <p>
            11/4 ويقر كل من الاطراف الثاني والثالث والرابع بصفتهم ضامنين
            متضامنين فيما بينهما بقيمة تلك المديونيات المستحقة للطرف الأول، كما
            يقر الطرفان الثالث والرابع بعدم أحقيتهم في الدفع أمام الطرف الثاني
            بالمقاصة أو مطالبته بالوفاء بأي التزامات فيما بينهم قبل الوفاء التام
          ...
          <p>
            ...
            الاجراءات القانونية بكل انواعها وفقا لنوع الدعاوي المقامة امام كافة
            المحاكم ودرجات التقاضي بها.
          </p>
        </section>
        ...
        <section className="term-container" title="fourteenth-term">
          ...
          <p>
            في حالة عدم إلتزام الطرف الثاني أو الضامنين بأي من إلتزاماتهم
            التعاقدية أو القانونية الواردة بهذا العقد وملحقاته ومرفقاته الموقعة
            (إن وجدت) وبالقوانين السارية في أي وقت من الأوقات يعد الأطراف الثاني
            والثالث والرابع مخفقين في الوفاء بإلتزاماتهم التعاقدية أو القانونية
            ويعتبر هذا العقد مفسوخا من تلقاء نفسه دون حاجة إلي اعذار أو اتخاذ
            إجراءات قضائية ويحق للطرف الأول فورا مطالبة أي من الاطراف الثاني
            والثالث والرابع مجتمعين معا او منفردين بباقي قيمة التمويل وكافة
            مصروفاته وتكاليف تمويله ومن حالات الإخفاق علي سبيل المثال وليس
            الحصرعلي ما يلي:
          </p>
          <p>
          ...
          <p>
            14/2 في حالة تقديم أي من الاطراف الثاني أو الثالث أو الرابع بيانات
            أو معلومات مخالفة للواقع أو غير سليمة للطرف الأول.
          </p>
          <p>
            14/3 في حالة فقد أي من الاطراف الثاني أو الثالث أو الرابع أهليتهم أو
            إشهار إفلاسهم أو إعسارهم أو وفاتهم أو وضعهم تحت الحراسة أو توقيع
            الحجز علي أموالهم أو وضع أموالهم تحت التحفظ ومنعهم من التصرف فيها أو
          ...
          <p>
            14/5 في حالة إخلال الأطراف الثاني أو الثالث أو الرابع بأي من
            التزاماتهم الأخرى الواردة بهذا العقد.
          </p>
        </section>
        ...
        <section className="term-container" title="eighteenth-term">
          ...
          <p>
            يتعهد الاطراف الثاني والثالث والرابع بصفتهم ضامنين متضامنين فيما
            بينهم بأن يمنعوا الغير من إتخاذ أي إجراءات تحفظية أو تنفيذية علي
            المنتجات أو البضائع او السلع أو الخدمات موضوع هذا العقد او ملحقاته
            المبيعة من الطرف الأول وعلي الطرف الثاني إخطار الطرف الأول بأي إجراء
            من هذا القبيل أو أي إجراءات تمس كافة الوارد سابقا ويحق للطرف الأول
            فسخ العقد فورا ويجب علي الطرف الثاني إتخاذ كافة الإجراءات بكافة
            السبل للإعتراض علي تلك الإجراءات وإخطار الغير بأنها ممولة من الطرف
            الاول.
          </p>
        </section>
        <section className="term-container" title="nineteenth-term">
          ...
          <p>
            يفوض ويأذن ويوافق الاطراف الثاني والثالث والرابع بأحقية الشركة الطرف
            الاول بإجراء الإستعلام الإئتماني عنهم من كافة الجهات الحكومية والغير
            الحكومية وكافة شركات التصنيف الإئتماني والبنوك والبنك المركزي المصري
            كما يقبل إتاحة بيانات هذا العقد وملاحقه وما قد يطرأ عليه من تعديلات
            وغير ذلك من بيانات/ معلومات اخري للجهات سالفة الذكر ولأي جهة اخري
            وللهيئة العامة للرقابة المالية سواء حالا او مستقبلا ويعتبر التوقيع
            علي هذا تصريحا وتفويضا منهم بذلك.
          </p>
        </section>
