  ...
  <div className="promissory-note" dir="rtl" lang="ar">
    ...
    <p>
      {customerGuarantors && customerGuarantors.length > 0
        ? 'نتعهد نحن الموقعين'
        : 'اتعهد انا الموقع'}
      &nbsp; ادناه تعهداً نهائيا وبدون اى قيد او شرط بأن ندفع فى تاريخ الاستحقاق
      لأمر واذن شركة حالا للتمويل الاستهلاكي مبلغ وقدره &nbsp;
    ...
    <p>
      ...
      سنوياً ، كما يستحق علينا عوائد تأخير بواقع ......... % من تاريخ الاستحقاق
      حتى تمام السداد وذلك بدون حاجة الى تنبيه او انذار.
    </p>
    <p>
