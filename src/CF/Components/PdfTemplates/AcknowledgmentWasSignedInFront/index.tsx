    ...
    <>
      <div className="contract-container" dir="rtl" lang="ar">
        ...
        <p>
          ...
          العميل و عقد الوديعة و السندات لأمر و إذن صحيحة و تحت مسئوليتي و أنني
          قمت بمطابقة أصل بطاقة الرقم القومي له مع الصور المرفقة بطلب التمويل
          (وجه و ظهر) و أنني قمت بمطابقتها معه و التأكد منه و أتحمل كافة
          المسئوليات بهذا الشأن .
        </p>
