    ...
    <table className="cf-contract-container">
      ...
      <div>
        ...
        <section className="term-container" title="nineteenth-term">
          ...
          <p>
            19/1 يفوض ويأذن ويوافق {term19Condition(noOfGuarantors)}بأحقية
            الشركة الطرف الاول بإجراء الإستعلام الإئتماني عنهم من كافة الجهات
            الحكومية والغير الحكومية وكافة شركات التصنيف الإئتماني والبنوك
            والبنك المركزي المصري كما يقبل إتاحة بيانات هذا العقد وملاحقه وما قد
            يطرأ عليه من تعديلات وغير ذلك من بيانات/ معلومات اخري للجهات سالفة
            الذكر ولأي جهة اخري وللهيئة العامة للرقابة المالية سواء حالا او
            مستقبلا ويعتبر التوقيع علي هذا تصريحا وتفويضا منهم بذلك.
          </p>
          <p>
            19/2 كما يفوض ويأذن ويوافق الاطراف الثاني والثالث والرابع والخامس
            باحقية الشركة الطرف الاول باتاحة بيانات هذا العقد للشركات الشقيقة
            والمرتبطة بالطرف الاول.
          </p>
        </section>
