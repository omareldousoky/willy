...
const MOHASSEL_APP_DIR = resolve(__dirname, '../src/Mohassel/')
...
module.exports = (env) => {
	...
	return {
		...
		resolve: {
			...
			modules: [MOHASSEL_APP_DIR, SHARED_DIR, '../node_modules'],
		},
		output: {
			filename: '[name].[hash].js',
			path: join(__dirname, '../build/mohassel'),
		},
		module: {
			rules: [{
					test: /\.tsx?$/,
